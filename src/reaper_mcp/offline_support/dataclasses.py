"""Dataclasses for offline RPP parsing + audio analysis (vendored from dschuler36)."""
...
class Track:
    ...
    audio_filepath: str
    fx_chain: list[FX]
    automation: dict[str, list[dict[str, float | str]]]
    peak_level: float
    send_levels: list[dict[str, str | float]]
